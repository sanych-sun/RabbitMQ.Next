...
namespace RabbitMQ.Next.Tests.Transport.Methods.Channel
{
    public class CloseMethodTests
    {
        ...
        {
            var expected = Helpers.GetFileContent("RabbitMQ.Next.Tests.Transport.Methods.Channel.CloseMethodPayload.dat");
        ...
        {
            var payload = Helpers.GetFileContent("RabbitMQ.Next.Tests.Transport.Methods.Channel.CloseMethodPayload.dat");
