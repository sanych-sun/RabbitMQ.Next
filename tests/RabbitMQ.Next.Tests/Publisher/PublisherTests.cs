...
//
//             await mock.channel.Received().SendAsync(new DeclareMethod("exchange"));
//         }
//
//         [Fact]
...
//             await publishTask;
//
//             await mock.channel.Received().SendAsync(Arg.Any<SelectMethod>());
//         }
//
//         [Fact]
...
//             await publisher.PublishAsync("test");
//
//             await mock.channel.DidNotReceive().SendAsync( Arg.Any<SelectMethod>());
//         }
//
//         [Fact]
