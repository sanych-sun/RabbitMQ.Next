...
public class QueueBindCommandTests
{
    ...
    {
        Assert.Throws<ArgumentNullException>(() => new QueueBindCommand(queue, "source", null));
    }
    ...
    {
        Assert.Throws<ArgumentNullException>(() => new QueueBindCommand("queue", exchange, null));
    }
