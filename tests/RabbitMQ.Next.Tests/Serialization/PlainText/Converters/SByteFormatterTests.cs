...
public class SByteFormatterTests
{
    ...
    {
        var formatter = new SByteConverter();
    ...
    public void CanParse(sbyte expected, params byte[][] parts)
    {
        ...
        var result = formatter.TryParse(sequence, out sbyte parsed);
    ...
    public void ParseThrowsOnWrongContent(byte[] content)
    {
        ...
        Assert.Throws<FormatException>(() => formatter.TryParse(sequence, out sbyte _));
    }
    ...
    public void ThrowsOnTooSmallBuffer()
    {
        ...
        Assert.Throws<OutOfMemoryException>(() => formatter.TryFormat((sbyte)42, bufferWriter));
    }
