...
namespace RabbitMQ.Next.Tests.Serialization.PlainText.Converters
{
    public class Int32FormatterTests
    {
        ...
        {
            var formatter = new Int32Converter();
        ...
        public void CanParse(int expected, params byte[][] parts)
        {
            ...
            var result = formatter.TryParse(sequence, out int parsed);
        ...
        public void ParseThrowsOnWrongContent(byte[] content)
        {
            ...
            Assert.Throws<FormatException>(() => formatter.TryParse(sequence, out int _));
        }
        ...
        public void ThrowsOnTooSmallBuffer()
        {
            ...
            Assert.Throws<OutOfMemoryException>(() => formatter.TryFormat(42, bufferWriter));
        }
