...
namespace RabbitMQ.Next.Tests.Serialization.PlainText.Converters
{
    public class UInt32FormatterTests
    {
        ...
        {
            var formatter = new UInt32Converter();
        ...
        public void CanParse(uint expected, params byte[][] parts)
        {
            ...
            var result = formatter.TryParse(sequence, out uint parsed);
        ...
        public void ParseThrowsOnWrongContent(byte[] content)
        {
            ...
            Assert.Throws<FormatException>(() => formatter.TryParse(sequence, out uint _));
        }
        ...
        public void ThrowsOnTooSmallBuffer()
        {
            ...
            Assert.Throws<OutOfMemoryException>(() => formatter.TryFormat((uint)42, bufferWriter));
        }
